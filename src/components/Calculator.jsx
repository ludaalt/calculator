...
import {
  updateCalculateValueAction,
  updateCalculateResultAction,
} from "../store/updateCalculateValue";
...
const CalculatorContainer = styled.div`
  ...
  background: linear-gradient(
    90deg,
    rgba(243, 231, 235, 255),
    rgba(227, 239, 255, 255)
  );
...
const Calculator = () => {
  ...
  const displayOperation = (operation) => {
    if (
      ...
      dispatch(
        updateCalculateValueAction(
          currentValue.toString() + operation.toString()
        )
      );
    }
